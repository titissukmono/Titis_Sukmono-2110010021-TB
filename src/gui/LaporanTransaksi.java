...
import static gui.LaporanTransaksi.maximixed;
...
public class LaporanTransaksi extends javax.swing.JDialog {
    ...
    public void dataTable(){
         Object[] Baris = {"No","Id Transaksi","Nama Pembeli","Telepon","pcs","Total","Bayar","Kembalian"};
        tabmode = new DefaultTableModel(null, Baris);
        tabelLapTransaksi.setModel(tabmode);
    ...
    public void pencarian(String sql){
      Object[] Baris = {"No","Id Transaksi","Nama Pembeli","Telepon","pcs","Total","Bayar","Kembalian"};
        tabmode = new DefaultTableModel(null, Baris);
        tabelLapTransaksi.setModel(tabmode);
        int brs = tabelLapTransaksi.getRowCount();
        for (int i = 0; 1 < brs; i++){
            tabmode.removeRow(1);
        }
        try{
     ...
     * @param parent
     */
    public LaporanTransaksi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        dataTable();       
        Locale local;
    ...
    private void initComponents() {
        ...
        tabelLapTransaksi = new javax.swing.JTable();
        ...
        labelNama.setText("Laporan Transaksi");
        ...
        tabelLapTransaksi.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        tabelLapTransaksi.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tabelLapTransaksi.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        tabelLapTransaksi.setRowHeight(30);
        tabelLapTransaksi.setRowMargin(2);
        tabelLapTransaksi.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tabelLapTransaksiMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tabelLapTransaksi);
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(btnCetak, javax.swing.GroupLayout.PREFERRED_SIZE, 139, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void tabelLapTransaksiMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelLapTransaksiMouseClicked
    ...
    }//GEN-LAST:event_tabelLapTransaksiMouseClicked
    ...
    private void tfCariKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tfCariKeyTyped
        String sqlPencarian = "select * from transaksi where Id_transaksi like '%"+tfCari.getText()+"%' or nama_pembeli like '%"+tfCari.getText()+"%'";
   ...
   try {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                LaporanTransaksi dialog = new LaporanTransaksi(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JTable tabelLapTransaksi;
