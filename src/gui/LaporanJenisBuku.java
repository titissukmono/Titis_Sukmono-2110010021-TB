...
public class LaporanJenisBuku extends javax.swing.JDialog {
    ...
    public void dataTable(){
        Object[] Baris = {"No","Kode Jenis","Nama Jenis Buku"};
        tabmode = new DefaultTableModel(null, Baris);
        tabeljnsBuku.setModel(tabmode);
    ...
    public void pencarian(String sql){
        ...
        tabmode = new DefaultTableModel(null, Baris);
        tabeljnsBuku.setModel(tabmode);
        int brs = tabeljnsBuku.getRowCount();
        for (int i = 0; 1 < brs; i++){
            tabmode.removeRow(1);
        }
        try{
     ...
     * @param parent
     */
    public LaporanJenisBuku(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        dataTable();       
        Locale local;
    ...
    private void initComponents() {
        ...
        tabeljnsBuku = new javax.swing.JTable();
        ...
        labelNama.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/icons8_chrome_reader_mode_50px.png"))); // NOI18N
        labelNama.setText("Laporan Jenis Buku");
        ...
        tabeljnsBuku.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        tabeljnsBuku.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null},
                {null, null, null},
                {null, null, null},
        ...
        tabeljnsBuku.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        tabeljnsBuku.setRowHeight(30);
        tabeljnsBuku.setRowMargin(2);
        tabeljnsBuku.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tabeljnsBukuMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tabeljnsBuku);
        if (tabeljnsBuku.getColumnModel().getColumnCount() > 0) {
            tabeljnsBuku.getColumnModel().getColumn(2).setHeaderValue("Title 3");
        }
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(tfCari, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(btnCetak, javax.swing.GroupLayout.PREFERRED_SIZE, 46, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void tabeljnsBukuMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabeljnsBukuMouseClicked
        int bar = tabeljnsBuku.getSelectedRow();
    ...
    }//GEN-LAST:event_tabeljnsBukuMouseClicked
    ...
    private void tfCariKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tfCariKeyTyped
        String sqlPencarian = "select * from jenis where kd_jns like '%"+tfCari.getText()+"%' or nama_jenis_buku like '%"+tfCari.getText()+"%'";
 ...
 try {
            ...
            File file = new File("src/report/LaporanJenisBuku.jasper");
           
           
//            JasDes = JRXmlLoader.load(file);
//            JasRep = JasperCompileManager.compileReport(JasDes);
            JasPri = JasperFillManager.fillReport(file.getPath(), null, conn);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LaporanJenisBuku.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                LaporanJenisBuku dialog = new LaporanJenisBuku(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JTable tabeljnsBuku;
